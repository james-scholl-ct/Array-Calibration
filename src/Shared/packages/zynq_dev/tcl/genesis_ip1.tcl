...
set files [list \
    $git_root/rtl_src/genesis_ip1.v \
    $git_root/rtl_src/genesis_axi_interface.v \
    $git_root/rtl_src/genesis_active_mem.v \
    $git_root/rtl_src/genesis_fifo.v \
    $git_root/rtl_src/genesis_ip1_io.v \
]
