...
set pins_constraints_file ${project_name}_constraints_pins.xdc
...
set files [list \
    $git_root/constraints/$top_constraints_file \
    $git_root/constraints/$pins_constraints_file]
