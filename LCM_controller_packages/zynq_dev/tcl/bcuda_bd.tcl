...
"
   foreach ip_block $ip_blocks {
      append list_check_ips " xilinx.com:ip:${project_name}_${ip_block}:1.0"
   }
...
proc create_root_design { parentCell project_name } {
  ...
  # Create ports
  set GPI_IP0 [ create_bd_port -dir I -from 1 -to 0 GPI_IP0 ]
  set GPI_IP1 [ create_bd_port -dir I -from 1 -to 0 GPI_IP1 ]
  set GPO_IP0 [ create_bd_port -dir O -from 1 -to 0 GPO_IP0 ]
  set GPO_IP1 [ create_bd_port -dir O -from 1 -to 0 GPO_IP1 ]

  # Create ip instance and set properties
  set ip0_inst ${project_name}_ip0_0
  set bd_cell [ create_bd_cell -type ip -vlnv xilinx.com:ip:${project_name}_ip0:1.0 $ip0_inst ]

  # Create ip instance and set properties
  set ip1_inst ${project_name}_ip1_0
  set bd_cell [ create_bd_cell -type ip -vlnv xilinx.com:ip:${project_name}_ip1:1.0 $ip1_inst ]

  # Create instance: processing_system7_0, and set properties
  set ps7_inst processing_system7_0
  set bd_cell [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 $ps7_inst ]
  ...
  set bd_cell [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ps7_0_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {2} \
 ] $bd_cell

  # Create instance: rst_ps7_0, and set properties
  set bd_cell [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins $ip0_inst/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins $ip1_inst/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net GPI_IP0 [get_bd_ports GPI_IP0] [get_bd_pins $ip0_inst/GPI]
  connect_bd_net -net GPI_IP1 [get_bd_ports GPI_IP1] [get_bd_pins $ip1_inst/GPI]

  connect_bd_net -net GPO_IP0 [get_bd_ports GPO_IP0] [get_bd_pins $ip0_inst/GPO]
  connect_bd_net -net GPO_IP1 [get_bd_ports GPO_IP1] [get_bd_pins $ip1_inst/GPO]

  connect_bd_net -net processing_system7_0_FCLK_CLK0 \
    [get_bd_pins $ip0_inst/s00_axi_aclk] \
    [get_bd_pins $ip1_inst/s00_axi_aclk] \
  ...
  connect_bd_net -net rst_ps7_0_interconnect_aresetn \
    [get_bd_pins ps7_0_axi_periph/ARESETN] \
    [get_bd_pins rst_ps7_0/interconnect_aresetn]

  connect_bd_net -net rst_ps7_0_peripheral_aresetn \
    [get_bd_pins $ip0_inst/s00_axi_aresetn] \
    [get_bd_pins $ip1_inst/s00_axi_aresetn] \
    [get_bd_pins ps7_0_axi_periph/M00_ARESETN] \
    [get_bd_pins ps7_0_axi_periph/M01_ARESETN] \
    [get_bd_pins ps7_0_axi_periph/S00_ARESETN] \
    [get_bd_pins rst_ps7_0/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs $ip0_inst/s00_axi/reg0] SEG_${project_name}_0_seg0
  create_bd_addr_seg -range 0x00001000 -offset 0x43C01000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs $ip1_inst/s00_axi/reg0] SEG_${project_name}_0_seg1
