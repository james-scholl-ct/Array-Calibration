...
set files [list \
    $git_root/rtl_src/delorean_spi.v \
    $git_root/rtl_src/delorean_regs.v \
    $git_root/rtl_src/delorean_axi_interface.v \
    $git_root/rtl_src/delorean_fifo.v \
    $git_root/rtl_src/delorean_spi_fsm.v \
    $git_root/rtl_src/delorean_spi_controller.v \
    $git_root/rtl_src/delorean_spi_io.v \
]
