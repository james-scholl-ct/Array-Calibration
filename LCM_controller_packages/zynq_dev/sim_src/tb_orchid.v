...
`define I_PS7                   tb_orchid.DUT.orchid_i.processing_system7_0.inst
`define ORCHID_BASE_ADDR        32'h43C0_0000
`define FPGA_RST_CTRL_DEFAULT   32'h01F33F0F

`define W2B(W)  (`ORCHID_BASE_ADDR | (W << 2))
        ...
        begin
            ...
            case( cmd )
                ...
                begin
                    ...
                    `I_PS7.read_data(`W2B(addr), 4, rdata, rresp);
                ...
                begin
                    ...
                    `I_PS7.write_data(`W2B(addr), 4, data, bresp);
