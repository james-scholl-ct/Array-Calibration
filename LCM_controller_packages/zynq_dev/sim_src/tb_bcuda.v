...
`define I_PS7                   tb_bcuda.DUT.bcuda_i.processing_system7_0.inst
`define FPGA_RST_CTRL_DEFAULT   32'h01F33F0F
`define AXI4_BCUDA_BASE_ADDR  32'h43C0_0000
        ...
        begin
            ...
            case( cmd )
                ...
                begin
                    ...
                    `I_PS7.read_data(`W2B(`AXI4_BCUDA_BASE_ADDR, addr), 4, rdata, rresp);
                ...
                begin
                    ...
                    `I_PS7.write_data(`W2B(`AXI4_BCUDA_BASE_ADDR, addr), 4, data, bresp);
