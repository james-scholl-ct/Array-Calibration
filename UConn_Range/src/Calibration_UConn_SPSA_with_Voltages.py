...
'''
phasemap = np.array([
    [9.80239, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147],
    [9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239],
    [8.40205, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239],
    [2.20054, 2.80068, 3.80093, 4.20103, 5.20127, 5.00122, 5.00122, 3.80093],
    [0.600147, 0.600147, 0.800195, 1.40034, 1.60039, 1.60039, 1.60039, 1.40034],
    [0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147],
    [9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 0.600147, 0.600147, 9.80239],
    [9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239],
    [9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239, 9.80239],
    [2.00049, 2.40059, 3.00073, 3.20078, 3.80093, 3.60088, 3.60088, 3.00073],
    [0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.400098, 0.600147, 0.600147],
    [0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147, 0.600147],
], dtype=float)
  '''
...
def main():
    ...
    for k in range(num_iters):
        ...
        if (k+1) % 5 == 0 or k == num_iters - 1:
            ...
            print(
                f"Iter {k:03d} | L+={Lp_print:.4f} L-={Lm_print:.4f} "
    ...
    #make sure rpi is outputting zeros to elements when program closes
